...
// Lokale Zeit verwenden (toISOString liefert UTC → Tagesversatz bei CEST)
const _nextTISO = `${_nextT.getFullYear()}-${String(_nextT.getMonth() + 1).padStart(2, '0')}-${String(_nextT.getDate()).padStart(2, '0')}`
